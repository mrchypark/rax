...
use rax_docstore::{validate_store_segment_against_dataset_pack, Docstore};
use rax_text::validate_store_segment_against_dataset_pack as validate_text_segment_against_dataset_pack;
use rax_vector::validate_store_segment_against_dataset_pack as validate_vector_segment_against_dataset_pack;
...
pub(crate) fn docstore_error(error: rax_docstore::DocstoreError) -> String {
    match error {
